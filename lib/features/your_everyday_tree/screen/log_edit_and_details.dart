...
import 'package:tread256/features/your_everyday_tree/controller/log_edit_controler.dart';
...
class LogEditAndDetails extends StatelessWidget {
  final LogEditControler controller = Get.put(LogEditControler());
  LogEditAndDetails({super.key});
